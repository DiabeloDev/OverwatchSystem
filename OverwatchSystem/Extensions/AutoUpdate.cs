    ...
    public static class UpdateChecker
    {
        ...
        public static void Run()
        {
            if (Plugin.Instance.Config.AutoUpdate)
            {
                ...
                Task.Run(() => CheckForUpdates(Plugin.Instance.Config.AutoUpdate));
            }
            else
            {
                LogInfo("Automatic update is disabled. Please check for updates manually.");
            }
        }
        ...
        {
            if (Plugin.Instance.Config.EnableBackup)
            {
